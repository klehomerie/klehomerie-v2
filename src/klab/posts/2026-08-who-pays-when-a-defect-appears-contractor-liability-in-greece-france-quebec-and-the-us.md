---
title: "Who pays when a defect appears: contractor liability in Greece, France,
  Quebec, and the US"
summary: In France and Quebec, a legal presumption or an insurer carries part of
  the structural risk after a renovation. In Greece, the US, and most of
...
image: /assets/images/uploads/contractor-feature-social.jpeg
---
## Table of contents

1. [Four liability universes](#1-four-liability-universes)
2. [North America is not one system](#2-north-america-is-not-one-system)
3. [The Greek Civil Code: acceptance, the clock, and the remedy ladder](#3-the-greek-civil-code-acceptance-the-clock-and-the-remedy-ladder)
4. [What acceptance looks like on a real delivery day](#4-what-acceptance-looks-like-on-a-real-delivery-day)
5. [Structuring the CapEx risk yourself](#5-structuring-the-capex-risk-yourself)
...
![](/assets/images/uploads/screenshot-2026-08-07-10.51.43-pm.png "Section 2, delivery verdict, first delivery inspection")
...
![](/assets/images/uploads/heading.png "Reserve card R-04, LOT 04, finishes and surfaces")
...
![](/assets/images/uploads/na.png "Section 8, financial position, separate delivery inspection")
...
5. If you come from a jurisdiction with more automatic protection, it does not travel with you. The habits it encouraged, documentation, holdbacks, verified contractor solvency, are worth bringing anyway.
   You now have the questions to ask before signature and the checks to run before acceptance. If you are signing a renovation contract in the next few months, the highest-value line you can still add is the retention percentage, and asking for it costs you nothing.
