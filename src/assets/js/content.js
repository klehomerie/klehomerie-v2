// content.js - BRAND IDENTITY 2.0 ALIGNED
...
window.translations = {
  'en': {
      ...
      heroSubtitle: 'Technical Asset Management for International Investors. We stop you from buying nightmares.', 
      heroCTA: 'Book a Technical Scan',

      // --- ABOUT SECTION ---
      aboutTitle: 'The Barrier Between You and Chaos', 
      aboutText: `Distance is the single biggest risk to your real estate investment. When you live thousands of miles away, you don't need a "host" to fluff pillows. You need a Technical Asset Manager to protect the concrete.\n\nI’m Arnaud Zerdab. I created Klehomerie because I watched international investors buy nightmares in Athens, one renovated-looking apartment at a time. My background isn't in hospitality. It's in Construction Site Management and Corporate Security. I don't just "check" apartments. I audit them.\n\nWe apply French technical standards to the Greek reality, on-site, in person. That means catching humidity before it eats through your walls. It means managing your CapEx so a contractor doesn't quietly overcharge you. Either way, we're the ones watching your asset's value when you can't be.`,
      
      // NEW ICONS TEXT
      iconRigorTitle: 'Technical Rigor',
      iconRigorText: 'Construction standards applied to management.',
      iconGuardTitle: 'Asset Guardianship',
      iconGuardText: 'Someone checks on your property every month, whether you are there or not.',
      ...
      serviceGateTitle: 'The Gatekeeper',
      serviceGateText: 'Before you plan a trip to Athens, we ensure the listing matches reality. We filter out the noise so you don\'t waste a flight.',
      
      // Pillar 2: The Authority
      serviceAuthTitle: 'The Authority',
      serviceAuthText: 'Before closing the deal, we run a forensic audit of the asset. We provide the technical leverage you need to negotiate price.',
      
      // Pillar 3: The Guardian
      serviceGuardTitle: 'The Guardian',
      serviceGuardText: 'Once the asset is yours, we deploy preservation maintenance. Corporate-grade reporting to protect the structure while you sleep.',
      
      // Pillar 4: The Coordinator
      serviceCoordTitle: 'The Coordinator',
      serviceCoordText: 'Renovations or repairs? We don\'t just "find a guy." We supervise the works to ensure they are done right, once.',

      // --- PACKAGES SECTION ---
      packagesTitle: 'Technical Service Packages', 
      packagesText: 'From "Red Flag" sanity checks to full monthly guardianship. Choose your level of protection.',

      // 1. RED FLAG SCAN (Price Highlighted)
      pkg_scan_title: 'Red Flag Scan<br><span class="text-3xl text-[--accent-color]">€97</span>',
      pkg_scan_desc: '<ul class="list-disc list-inside space-y-3 text-left"><li><b>The "Sanity Check"</b></li><li>45-min Visual Diagnostic</li><li>Go/No-Go Verdict</li></ul>',
      ...
      pkg_guardian_desc: '<ul class="list-disc list-inside space-y-3 text-left"><li><b>For Vacant Luxury Assets</b></li><li>Monthly "Pulse Check"</li><li>Flush Systems & Cycle AC</li><li><b>Post-Disaster Check (Storm/Quake)</b></li><li>Vendor Access Control</li></ul>',
      ...
      rc_guardpremium_desc: 'Monthly Vacant Asset Guardianship Core plus 2 visits/month, system flushing, humidity airing, and guest access coordination.',
      ...
      faq_q1: "What is Technical Asset Management (TAM)?",
      faq_a1: "Technical Asset Management (TAM) is all about keeping your property <b>structurally and functionally sound</b>, protecting its value over time.<br><br>Unlike standard property management, which focuses on tenants and appearances, TAM focuses on the building’s <b>core systems and long-term health</b>.<br><br>We identify risks and maintenance needs <b>before they become costly problems</b>, giving you confidence in your investment.",
      
      faq_q2: "How is it different from traditional property management in Athens?",
      ...
      faq_a4: "The Golden Ticket Audit is a <b>full technical evaluation</b>. We check six asset classes:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>General Environment:</b> Overall building health and safety</li><li><b>Electrical Systems:</b> Safety, functionality, and efficiency</li><li><b>Plumbing and HVAC:</b> Flow, pressure, and overall integrity</li><li><b>Joinery and Closings:</b> Doors, windows, and fittings</li><li><b>Finishes and Surfaces:</b> Wear, moisture, and hidden damage</li><li><b>Amenities and White Goods:</b> Refrigerator, oven, dishwasher, and other built-in appliances</li></ul><br>We use advanced tools like <b>thermal imaging</b> and <b>stress tests</b> to produce a <b>risk-rated roadmap</b>, helping you plan maintenance and investments strategically.<br><br><b>Beyond the Surface:</b> Our thermal imaging identifies hidden moisture, insulation gaps, and thermal bridges that the naked eye misses entirely.<br><br><a href='#packages' class='inline-block text-[--accent-color] font-bold hover:underline'>→ Get a comprehensive view of your property’s health with a Golden Ticket Audit.</a>",
      faq_q5: "How does CapEx planning impact long-term value?",
      faq_a5: "CapEx (Capital Expenditure) planning helps you <b>forecast major investments</b> over a 5-year horizon, ensuring you:<ul class='list-disc pl-5 mt-2 space-y-1'><li>Avoid costly emergency repairs</li><li>Protect the property’s value and yield</li><li>Make strategic upgrades at the right time</li></ul><br>By understanding the lifecycle of roofs, HVAC units, and other critical systems, you can <b>manage your portfolio proactively</b>, not reactively.",
      
      faq_q6: "Do I still need a Greek Civil Engineer or Lawyer?",
      faq_a6: "Yes. Our role is <b>strictly technical and advisory</b>:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Civil Engineer (Michanikos):</b> Required for urban planning approvals and legality statements</li><li><b>Lawyer:</b> Needed for title verification and contract execution</li></ul><br>Klehomerie looks for <b>'Pathology'</b>. We are your <b>technical eyes on the ground before</b> you engage the heavy legal machinery.<br>We find the problems so the Engineer knows where to look.<br><br>For the exact boundary between our technical role and their legal one, see our <a href='/scope/' class='text-[--accent-color] font-bold hover:underline'>full scope of service</a>.",
      
      faq_q7: "Who is Klehomerie NOT for?",
      faq_a7: "To maintain our high technical standards, we do not offer hospitality services. We are not the right fit for:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Guest Management:</b> We do not handle Airbnb bookings, check-ins, or guest messaging.</li><li><b>Concierge Requests:</b> We do not coordinate cleaning, laundry, or interior styling.</li></ul><br><b>Klehomerie is built for Institutional & Sophisticated Investors.</b><br>We are the <b>Technical Directors</b> of the asset. We work perfectly <i>alongside</i> your property manager or hosting team. They keep the guests happy. We keep the building standing.",        
      faq_q8: "Why shouldn't I just hire a local contractor?",
      faq_a8: "You can, but a contractor makes money by finding problems <b>they</b> can fix.<br>Which creates a <b>conflict of interest</b>.<br>Klehomerie is <b>independent</b>. We do not sell construction work. We sell <b>unbiased data</b>.<br>When we tell you a wall needs fixing, it’s because it’s true, not because we want the painting job.<br>Our fee protects you from unnecessary €5,000 renovation quotes.<br><br><a href='https://calendar.app.google/pNE9HLdXuUtCwgEi7' target='_blank' class='inline-block text-[--accent-color] font-bold hover:underline'>→ Book a 15-min Clarity Call</a>",        
      
      // New Strategic Independence FAQs (Perplexity Alignment)
      faq_q9: "Is Klehomerie independent from Athens real estate brokers and developers?",
      faq_a9: "Yes. Klehomerie operates strictly on an independent, buyer-side mandate. We maintain zero commercial partnerships, referral agreements, or financial ties with real estate agencies, brokers, or developers in Greece.",
      faq_q10: "Does Klehomerie accept commissions from renovation contractors?",
      faq_a10: "No. We enforce a strict anti-kickback policy. We accept zero commissions, finders' fees, or rebates from contractors or architects. 100% of our compensation comes directly from our clients.",
      faq_q11: "Why does Klehomerie separate property inspection from repair execution?",
      faq_a11: "To eliminate conflicts of interest. We provide unbiased forensic diagnostics and worksite coordination, but we never sell repair or construction services. We have no financial incentive to inflate or invent property defects.",

      // --- CONTACT & FOOTER ---
      contactTitle: 'How Can You Secure Your Asset?',
      contactName: 'Name',
      contactEmail: 'Email',
      contactMessage: 'Technical Issue / Risk Assessment',
      contactButton: 'Request Protection',
      ...
      methodologyMandateText2: 'We say this outright because an asset manager who claims to do everything is usually the one doing nothing to a verifiable standard. Our value is the barrier we put between your asset and local operational chaos, not a claim to expertise we do not hold. The full detail of where our mandate starts and stops, lot by lot, is set out on our <a href="/scope/" class="text-[--accent-color] font-bold hover:underline">scope of service page</a>.',
      ...
      privacy_s1_p: 'The entity responsible for processing your personal data is:',
      privacy_s1_ul: '<li><strong>Company Name:</strong> Klehomerie (Arnaud Zerdab)</li><li><strong>VAT Number (AFM):</strong> 174294556</li><li><strong>Headquarters:</strong> ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ</li><li><strong>Contact Email:</strong> gdpr@klehomerie.com</li>',
      privacy_s2_h: '2. Types of Data We Collect',
      privacy_s2_p: 'We collect and process the following categories of personal data necessary for our services:',
      privacy_s2_ul: '<li><strong>Identity Data:</strong> Full name, father\'s name, ID/Passport number, AFM (Tax ID).</li><li><strong>Contact Data:</strong> Email address, phone number, residential address.</li><li><strong>Asset Data:</strong> Ownership details, asset location, technical specifications, condition records, keys, and access codes.</li><li><strong>Financial Data:</strong> Bank account details (IBAN) for expense reimbursements and fee payments (we do not store credit card numbers).</li>',
      privacy_s2_p2: 'We do not collect or process special categories of personal data as defined in Article 9 GDPR.',
      privacy_s3_h: '3. Purpose of Processing',
      privacy_s3_p: 'Your data is processed for the following specific purposes:',
      privacy_s3_ul: '<li><strong>Marketing purposes:</strong> To send you newsletters, technical insights, and promotional updates regarding Klehomerie\'s asset management services, subject to your explicit consent.</li><li><strong>Performance of Contract:</strong> To execute the Technical Asset Management Service Agreement, coordinate repairs and CapEx projects, and represent you before utility companies (DEDDIE, EYDAP) within the scope of your engagement.</li><li><strong>Legal Compliance:</strong> To comply with tax obligations (AADE declarations) and other regulatory requirements.</li><li><strong>Communication:</strong> To provide updates on your asset condition, send Technical Audit reports, and respond to your inquiries.</li><li><strong>Educational Content &amp; Case Studies:</strong> To analyze technical asset data for the creation of industry insights and case studies, ensuring all personal identifiers and specific asset locations are strictly anonymized prior to any publication.</li><li><strong>Record Integrity and Legal Defence:</strong> To maintain records of instructions, works, and technical findings, to secure our systems, and to establish, exercise, or defend legal claims.</li>',
      privacy_s4_h: '4. Legal Basis',
      privacy_s4_p: 'Under Article 6 GDPR, each purpose above rests on a specific lawful basis:',
      privacy_s4_ul: '<li><strong>Contractual necessity (Article 6(1)(b)):</strong> Performance of Contract and Communication.</li><li><strong>Legal obligation (Article 6(1)(c)):</strong> Legal Compliance, including Greek tax and accounting legislation.</li><li><strong>Legitimate interests (Article 6(1)(f)):</strong> Record Integrity and Legal Defence. We have assessed that these interests do not override your rights and freedoms. You may object at any time (see Section 8).</li><li><strong>Consent (Article 6(1)(a)):</strong> Marketing purposes and Educational Content &amp; Case Studies.</li>',
      privacy_s4_p2: 'Consent is optional and separate from your Service Agreement. Granting or refusing it has no effect on the services you receive, and it may be withdrawn at any time, free of charge.',
      privacy_s5_h: '5. Data Recipients',
      privacy_s5_p: 'We do not sell your data. We may share necessary data with:',
      privacy_s5_ul: '<li><strong>Public Authorities:</strong> Tax authorities (AADE) and utility providers (DEDDIE, EYDAP) when required by law or for contract execution.</li><li><strong>Third-Party Vendors:</strong> Trusted contractors (plumbers, electricians, engineers) strictly for maintenance and repair tasks at your asset.</li><li><strong>Professional Advisors:</strong> Accountants and legal counsels bound by confidentiality.</li>',
      privacy_s6_h: '6. International Data Transfers',
      privacy_s6_p: 'Where Klehomerie uses cloud-based tools (such as Google Workspace) to store or process your data, any transfer of personal data outside the European Economic Area is carried out under appropriate safeguards, including the European Commission\'s Standard Contractual Clauses (SCCs), in accordance with GDPR Chapter V.',
      privacy_s7_h: '7. Data Retention',
      privacy_s7_p1: 'We retain your personal data for the duration of our contractual relationship. After termination, data is kept only for the period required by Greek tax and accounting legislation (typically five to ten years) or to resolve legal disputes, after which it is securely deleted.',
      privacy_s7_p2: 'Keys, alarm codes, and access credentials are returned or destroyed within 30 days of termination, regardless of the retention period applying to other records.',
      privacy_s8_h: '8. Your Rights',
      privacy_s8_p: 'Under GDPR, you have the right to:',
      privacy_s8_ul: '<li><strong>Access:</strong> Request a copy of the personal data we hold about you.</li><li><strong>Rectification:</strong> Correct inaccurate or incomplete data.</li><li><strong>Erasure ("Right to be Forgotten"):</strong> Request deletion of your data, subject to legal retention obligations.</li><li><strong>Restriction:</strong> Request to limit the processing of your data.</li><li><strong>Object:</strong> Object to processing based on our legitimate interests or carried out for direct marketing purposes.</li><li><strong>Withdraw Consent:</strong> Withdraw any consent you have given, at any time and free of charge. Withdrawal does not affect the lawfulness of processing carried out before withdrawal, and has no effect on your Service Agreement.</li><li><strong>Portability:</strong> Receive your data in a structured, commonly used format.</li>',
      privacy_s8_p2: 'To exercise these rights, please contact us at <a href="mailto:gdpr@klehomerie.com" class="text-[--accent-color] font-bold">gdpr@klehomerie.com</a>. We will respond within one month of receipt.',
      privacy_s8_p3: 'You also have the right to lodge a complaint with the Hellenic Data Protection Authority (Αρχή Προστασίας Δεδομένων Προσωπικού Χαρακτήρα) if you believe your data protection rights have been violated:',
      privacy_s8_p4: 'Kifissias 1-3, 115 23 Athens, Greece | Tel. +30 210 6475600 | <a href="mailto:contact@dpa.gr" class="text-[--accent-color] font-bold">contact@dpa.gr</a> | <a href="https://www.dpa.gr" class="text-[--accent-color] font-bold" target="_blank" rel="noopener">www.dpa.gr</a>',
      privacy_s9_h: '9. Security',
      privacy_s9_p: 'We implement appropriate technical and organizational measures to protect your data against unauthorized access, loss, or misuse. This includes secure digital storage and limited access to physical files.',
      privacy_s10_h: '10. Updates',
      privacy_s10_p: 'We may update this notice to reflect legal or operational changes. Each version carries a version number and effective date. The latest version will always be available on our website.',

      // --- TERMS OF SERVICE ---
      terms_title: 'LEGAL NOTICE &amp; TERMS OF SERVICE',
      terms_updated: 'Last Updated: July 2026',
      terms_s1_h: '1. Legal Identity',
      terms_s1_p1: 'Services are provided by <strong>Klehomerie</strong> (AFM: 174294556), with registered office at ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ, Greece.',
      terms_s1_contact: '<strong>Contact:</strong> <a href="mailto:info@klehomerie.com" class="hover:text-[--accent-color]">info@klehomerie.com</a><br><strong>Phone:</strong> +30 694 020 6368<br><strong>Website:</strong> <a href="https://www.klehomerie.com" target="_blank">www.klehomerie.com</a>',
      terms_s2_h: '2. Nature of Services &amp; Liability',
      ...
      terms_s4_p: 'Invoices are payable within <strong>7 business days</strong> of issuance, unless a private agreement states otherwise. Late payments accrue interest at the ECB base rate + 8%.',
      terms_s5_h: '5. Client Rights &amp; Termination',
      terms_s5_ul: '<li><strong>Monthly Service Plans:</strong> Clients may terminate with <strong>14 days\' written notice, following an initial 3-month term</strong>. <strong>Project-based engagements</strong> may be terminated by either party prior to completion with <strong>7 days\' written notice</strong>, per the applicable Service Agreement.</li><li><strong>Right of withdrawal:</strong> Consumers have 14 days to withdraw from distance contracts per Law 2251/1994.</li><li>We may terminate immediately for material breach (e.g., unapproved contractor interference, abusive behavior, or non-payment).</li>',
      terms_s6_h: '6. Data Protection (GDPR)',
      terms_s6_p1: 'We process personal data per EU GDPR and Greek Law 4624/2019. Clients may access, rectify, delete, restrict, or object to processing via <a href="mailto:gdpr@klehomerie.com">gdpr@klehomerie.com</a>.',
      terms_s6_p2: 'Full policy available here: <a href="/legal/privacy/" class="text-[--accent-color] font-bold hover:underline">Privacy Policy</a>.',
      terms_s7_h: '7. Intellectual Property &amp; Website Use',
      terms_s7_p: 'Website content is owned by Klehomerie. Users may not reproduce it without permission. We disclaim liability for user-submitted content.',
      terms_s8_h: '8. Governing Law &amp; Disputes',
      terms_s8_p1: 'These Terms are governed by Greek law. Disputes fall under exclusive jurisdiction of Athens Courts. For EU consumers, alternative dispute resolution is available via <a href="https://www.eccnet.eu" target="_blank" rel="nofollow" class="underline">www.eccnet.eu</a>.',
      terms_s8_p2: 'These Terms are published in English; where translated versions exist, the English version shall prevail in the event of any discrepancy.',
      terms_footer: 'Changes may apply; continued use implies acceptance.'
  },
  ...
  'fr': {
      ...
      heroCTA: 'Réserver un Scan Technique',

      // --- ABOUT SECTION ---
      aboutTitle: 'Le Rempart entre Vous et le Chaos', 
      aboutText: `La distance est le risque majeur pour votre investissement immobilier. Quand vous vivez à des milliers de kilomètres, vous n'avez pas besoin d'un "hôte" pour tapoter les coussins. Vous avez besoin d'un Gestionnaire Technique pour protéger le béton.\n\nJe suis Arnaud Zerdab. J'ai créé Klehomerie car j'ai vu des investisseurs internationaux acheter des gouffres financiers à Athènes. Mon parcours n'est pas dans l'hôtellerie, mais dans la Conduite de Travaux et la Sécurité d'Entreprise. Je ne "visite" pas les appartements ; je les audite.\n\nNous sommes vos yeux et vos oreilles sur le terrain, appliquant la rigueur technique française à la réalité grecque. Qu'il s'agisse de diagnostiquer l'humidité avant qu'elle ne ravage vos murs ou de piloter vos CAPEX pour éviter les surfacturations, nous sommes les gardiens de la valeur de votre actif.`,

      // ICONS
      iconRigorTitle: 'Rigueur Technique',
      iconRigorText: 'L\'exigence du BTP appliquée à la gestion.',
      iconGuardTitle: 'Protection d\'Actif',
      iconGuardText: 'Surveillance structurelle en votre absence.',
      ...
      serviceAuthText: 'Avant la signature, nous réalisons un audit inquisiteur de l\'actif. Nous vous fournissons le levier technique nécessaire pour négocier le prix.',

      serviceGuardTitle: 'Le Gardien',
      serviceGuardText: 'Une fois l\'actif acquis, nous déployons une maintenance préventive. Des rapports de niveau "Corporate" pour que vous dormiez sur vos deux oreilles.',

      serviceCoordTitle: 'Le Pilote',
      serviceCoordText: 'Rénovations ou réparations ? Nous ne faisons pas que "trouver un gars". Nous pilotons le chantier pour que ce soit fait dans les règles de l\'art, du premier coup.',

      // --- PACKAGES SECTION ---
      packagesTitle: 'Forfaits de Services Techniques', 
      packagesText: 'Du simple contrôle de viabilité au gardiennage mensuel. Choisissez votre niveau de protection.',

      pkg_scan_title: 'Scan "Red Flag"<br><span class="text-3xl text-[--accent-color]">97€</span>',
      ...
      rc_guardpremium_desc: 'Gardiennage Core, plus 2 visites/mois, purge des réseaux, aération anti-humidité et coordination d\'accès invités.',
      ...
      faq_q1: "Qu'est-ce que le Technical Asset Management ?",
      faq_a1: "Le <b>Technical Asset Management (TAM)</b> consiste à maintenir l’intégrité <b>structurelle et fonctionnelle</b> de votre propriété, protégeant ainsi sa valeur au fil du temps.<br><br>Contrairement à la gestion locative classique, qui se concentre sur les locataires et l'esthétique, le TAM se concentre sur les <b>systèmes vitaux et la santé à long terme</b> du bâtiment.<br><br>Nous identifions les risques et les besoins de maintenance <b>avant qu'ils ne deviennent des pathologies coûteuses</b>, vous donnant ainsi une totale confiance dans votre investissement.",
      
      faq_q2: "En quoi est-ce différent de la gestion traditionnelle ?",
      ...
      faq_a4: "L'Audit Golden Ticket est une <b>évaluation technique intégrale</b>. Nous analysons six catégories fixes :<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Environnement Général :</b> Salubrité et sécurité des communs.</li><li><b>Systèmes Électriques :</b> Sécurité, mise aux normes et vétusté.</li><li><b>Plomberie et CVC :</b> Débit, pression et intégrité des réseaux.</li><li><b>Menuiseries et Fermetures :</b> État des ouvrants et isolation.</li><li><b>Finitions et Surfaces :</b> Usure, traces d'humidité et vices cachés.</li><li><b>Équipements et Électroménager :</b> Réfrigérateur, four, lave-vaisselle et autres appareils encastrés.</li></ul><br>Nous utilisons des outils avancés (<b>imagerie thermique</b>, tests de charge) pour produire une <b>feuille de route d'investissement</b>.<br><br><b>Au-delà du visible :</b> Notre caméra thermique détecte l'humidité encastrée, les ruptures d'isolant et les ponts thermiques invisibles à l'œil nu.<br><br><a href='#packages' class='inline-block text-[--accent-color] font-bold hover:underline'>→ Obtenez une vision radiographique de votre propriété avec un Audit Golden Ticket.</a>",
      ...
      // Alignement Stratégique d'Indépendance (FAQ Perplexity)
      ...
      // --- CONTACT ---
      contactTitle: 'Sécurisez Votre Actif',
      contactName: 'Nom',
      contactEmail: 'Email',
      contactMessage: 'Problème Technique / Risque Identifié',
      ...
      methodologyMandateText2: 'Nous le disons sans détour, car un gestionnaire d\'actifs qui prétend tout faire est généralement celui qui ne fait rien selon un standard vérifiable. Notre valeur réside dans le rempart que nous plaçons entre votre actif et le chaos opérationnel local, non dans une prétention à des compétences que nous ne détenons pas. Le détail complet des limites de notre mandat, catégorie par catégorie, est disponible sur notre <a href="/scope/" class="text-[--accent-color] font-bold hover:underline">page de périmètre de mission</a>.',
      ...
      privacy_s1_p: 'L\'entité responsable du traitement de vos données personnelles est :',
      privacy_s1_ul: '<li><strong>Raison sociale :</strong> Klehomerie (Arnaud Zerdab)</li><li><strong>Numéro de TVA (AFM) :</strong> 174294556</li><li><strong>Siège social :</strong> ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ</li><li><strong>E-mail de contact :</strong> gdpr@klehomerie.com</li>',
      privacy_s2_h: '2. Types de Données Collectées',
      privacy_s2_p: 'Nous collectons et traitons les catégories de données personnelles suivantes, nécessaires à nos services :',
      privacy_s2_ul: '<li><strong>Données d\'identité :</strong> Nom complet, nom du père, numéro de carte d\'identité/passeport, AFM (numéro fiscal).</li><li><strong>Données de contact :</strong> Adresse e-mail, numéro de téléphone, adresse de résidence.</li><li><strong>Données relatives à l\'actif :</strong> Détails de propriété, localisation du bien, spécifications techniques, relevés d\'état, clés et codes d\'accès.</li><li><strong>Données financières :</strong> Coordonnées bancaires (IBAN) pour le remboursement de frais et le paiement des honoraires (nous ne conservons pas les numéros de carte bancaire).</li>',
      privacy_s2_p2: 'Nous ne collectons ni ne traitons de catégories particulières de données au sens de l\'article 9 du RGPD.',
      privacy_s3_h: '3. Finalités du Traitement',
      privacy_s3_p: 'Vos données sont traitées pour les finalités spécifiques suivantes :',
      privacy_s3_ul: '<li><strong>Finalités marketing :</strong> Pour vous envoyer des newsletters, des analyses techniques et des offres promotionnelles concernant les services de gestion d\'actifs de Klehomerie, sous réserve de votre consentement explicite.</li><li><strong>Exécution du contrat :</strong> Pour exécuter le Contrat de Gestion Technique d\'Actifs, coordonner les réparations et projets CapEx, et vous représenter auprès des compagnies de service public (DEDDIE, EYDAP) dans le cadre de votre mandat.</li><li><strong>Conformité légale :</strong> Pour satisfaire aux obligations fiscales (déclarations AADE) et aux autres exigences réglementaires.</li><li><strong>Communication :</strong> Pour vous informer de l\'état de votre actif, vous envoyer les rapports d\'Audit Technique, et répondre à vos demandes.</li><li><strong>Contenu éducatif &amp; études de cas :</strong> Pour analyser les données techniques des actifs afin de produire des analyses sectorielles et des études de cas, tous les identifiants personnels et les localisations précises des actifs étant strictement anonymisés avant toute publication.</li><li><strong>Intégrité des dossiers et défense juridique :</strong> Pour conserver les registres des instructions, travaux et constats techniques, sécuriser nos systèmes, et établir, exercer ou défendre des droits en justice.</li>',
      privacy_s4_h: '4. Base Légale',
      privacy_s4_p: 'En vertu de l\'article 6 du RGPD, chacune des finalités ci-dessus repose sur une base légale spécifique :',
      privacy_s4_ul: '<li><strong>Nécessité contractuelle (article 6(1)(b)) :</strong> Exécution du contrat et Communication.</li><li><strong>Obligation légale (article 6(1)(c)) :</strong> Conformité légale, y compris la législation fiscale et comptable grecque.</li><li><strong>Intérêts légitimes (article 6(1)(f)) :</strong> Intégrité des dossiers et défense juridique. Nous avons évalué que ces intérêts ne priment pas sur vos droits et libertés. Vous pouvez vous y opposer à tout moment (voir Section 8).</li><li><strong>Consentement (article 6(1)(a)) :</strong> Finalités marketing et Contenu éducatif &amp; études de cas.</li>',
      privacy_s4_p2: 'Le consentement est facultatif et distinct de votre Contrat de Service. L\'accorder ou le refuser n\'a aucune incidence sur les prestations dont vous bénéficiez, et il peut être retiré à tout moment, gratuitement.',
      privacy_s5_h: '5. Destinataires des Données',
      privacy_s5_p: 'Nous ne vendons pas vos données. Nous pouvons partager les données nécessaires avec :',
      privacy_s5_ul: '<li><strong>Autorités publiques :</strong> Autorités fiscales (AADE) et fournisseurs d\'utilités (DEDDIE, EYDAP) lorsque la loi l\'exige ou pour l\'exécution du contrat.</li><li><strong>Prestataires tiers :</strong> Artisans de confiance (plombiers, électriciens, ingénieurs) strictement pour les tâches de maintenance et de réparation sur votre actif.</li><li><strong>Conseillers professionnels :</strong> Experts-comptables et conseils juridiques tenus à la confidentialité.</li>',
      privacy_s6_h: '6. Transferts Internationaux de Données',
      privacy_s6_p: 'Lorsque Klehomerie utilise des outils basés sur le cloud (tels que Google Workspace) pour stocker ou traiter vos données, tout transfert de données personnelles hors de l\'Espace Économique Européen est réalisé dans le cadre de garanties appropriées, notamment les Clauses Contractuelles Types (CCT) de la Commission Européenne, conformément au Chapitre V du RGPD.',
      privacy_s7_h: '7. Conservation des Données',
      privacy_s7_p1: 'Nous conservons vos données personnelles pendant la durée de notre relation contractuelle. Après la fin de celle-ci, les données ne sont conservées que pendant la période exigée par la législation fiscale et comptable grecque (généralement de cinq à dix ans) ou pour résoudre un litige, avant d\'être supprimées de manière sécurisée.',
      privacy_s7_p2: 'Les clés, codes d\'alarme et identifiants d\'accès sont restitués ou détruits dans un délai de 30 jours suivant la fin du contrat, indépendamment de la durée de conservation applicable aux autres registres.',
      privacy_s8_h: '8. Vos Droits',
      privacy_s8_p: 'En vertu du RGPD, vous disposez du droit :',
      privacy_s8_ul: '<li><strong>D\'accès :</strong> Demander une copie des données personnelles que nous détenons sur vous.</li><li><strong>De rectification :</strong> Corriger des données inexactes ou incomplètes.</li><li><strong>D\'effacement (« droit à l\'oubli ») :</strong> Demander la suppression de vos données, sous réserve des obligations légales de conservation.</li><li><strong>De limitation :</strong> Demander la limitation du traitement de vos données.</li><li><strong>D\'opposition :</strong> Vous opposer à un traitement fondé sur nos intérêts légitimes ou réalisé à des fins de marketing direct.</li><li><strong>De retrait du consentement :</strong> Retirer tout consentement donné, à tout moment et gratuitement. Le retrait n\'affecte pas la licéité du traitement effectué avant celui-ci et n\'a aucune incidence sur votre Contrat de Service.</li><li><strong>De portabilité :</strong> Recevoir vos données dans un format structuré et couramment utilisé.</li>',
      privacy_s8_p2: 'Pour exercer ces droits, veuillez nous contacter à l\'adresse <a href="mailto:gdpr@klehomerie.com" class="text-[--accent-color] font-bold">gdpr@klehomerie.com</a>. Nous répondrons dans un délai d\'un mois à compter de la réception de votre demande.',
      privacy_s8_p3: 'Vous disposez également du droit d\'introduire une réclamation auprès de l\'Autorité Hellénique de Protection des Données (Αρχή Προστασίας Δεδομένων Προσωπικού Χαρακτήρα) si vous estimez que vos droits en matière de protection des données ont été violés :',
      privacy_s8_p4: 'Kifissias 1-3, 115 23 Athènes, Grèce | Tél. +30 210 6475600 | <a href="mailto:contact@dpa.gr" class="text-[--accent-color] font-bold">contact@dpa.gr</a> | <a href="https://www.dpa.gr" class="text-[--accent-color] font-bold" target="_blank" rel="noopener">www.dpa.gr</a>',
      privacy_s9_h: '9. Sécurité',
      privacy_s9_p: 'Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre tout accès non autorisé, perte ou usage abusif. Cela inclut un stockage numérique sécurisé et un accès limité aux dossiers physiques.',
      privacy_s10_h: '10. Mises à Jour',
      privacy_s10_p: 'Nous pouvons mettre à jour le présent avis pour refléter des évolutions légales ou opérationnelles. Chaque version comporte un numéro de version et une date d\'entrée en vigueur. La dernière version est toujours disponible sur notre site.',

      // --- TERMS OF SERVICE ---
      terms_title: 'MENTIONS LÉGALES ET CONDITIONS GÉNÉRALES DE SERVICE',
      terms_updated: 'Dernière mise à jour : juillet 2026',
      terms_s1_h: '1. Identité Légale',
      terms_s1_p1: 'Les services sont fournis par <strong>Klehomerie</strong> (AFM : 174294556), dont le siège social est situé ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ, Grèce.',
      terms_s1_contact: '<strong>Contact :</strong> <a href="mailto:info@klehomerie.com" class="hover:text-[--accent-color]">info@klehomerie.com</a><br><strong>Téléphone :</strong> +30 694 020 6368<br><strong>Site web :</strong> <a href="https://www.klehomerie.com" target="_blank">www.klehomerie.com</a>',
      terms_s2_h: '2. Nature des Services et Responsabilité',
      ...
      terms_s4_p: 'Les factures sont payables sous <strong>7 jours ouvrés</strong> à compter de leur émission, sauf accord particulier contraire. Les paiements en retard portent intérêt au taux de base de la BCE majoré de 8 %.',
      terms_s5_h: '5. Droits du Client et Résiliation',
      terms_s5_ul: '<li><strong>Forfaits mensuels de service :</strong> Le client peut résilier avec un <strong>préavis écrit de 14 jours, à l\'issue d\'une période initiale de 3 mois</strong>. Les <strong>missions ponctuelles (au projet)</strong> peuvent être résiliées par l\'une ou l\'autre des parties avant leur achèvement, moyennant un <strong>préavis écrit de 7 jours</strong>, conformément au Contrat de Service applicable.</li><li><strong>Droit de rétractation :</strong> Les consommateurs disposent de 14 jours pour se rétracter d\'un contrat à distance, conformément à la loi 2251/1994.</li><li>Nous pouvons résilier immédiatement en cas de manquement grave (par exemple, intervention non autorisée d\'un prestataire, comportement abusif ou non-paiement).</li>',
      terms_s6_h: '6. Protection des Données (RGPD)',
      terms_s6_p1: 'Nous traitons les données personnelles conformément au RGPD et à la loi grecque 4624/2019. Les clients peuvent accéder à leurs données, les rectifier, les supprimer, en limiter le traitement ou s\'y opposer, via <a href="mailto:gdpr@klehomerie.com">gdpr@klehomerie.com</a>.',
      terms_s6_p2: 'La politique complète est disponible ici : <a href="/legal/privacy/" class="text-[--accent-color] font-bold hover:underline">Politique de Confidentialité</a>.',
      terms_s7_h: '7. Propriété Intellectuelle et Utilisation du Site',
      terms_s7_p: 'Le contenu du site est la propriété de Klehomerie. Les utilisateurs ne peuvent le reproduire sans autorisation. Nous déclinons toute responsabilité concernant le contenu soumis par les utilisateurs.',
      terms_s8_h: '8. Droit Applicable et Litiges',
      terms_s8_p1: 'Les présentes Conditions sont régies par le droit grec. Les litiges relèvent de la compétence exclusive des tribunaux d\'Athènes. Pour les consommateurs de l\'UE, un mode de résolution alternative des litiges est disponible via <a href="https://www.eccnet.eu" target="_blank" rel="nofollow" class="underline">www.eccnet.eu</a>.',
      terms_s8_p2: 'Les présentes Conditions sont publiées en anglais ; en cas d\'existence de versions traduites, la version anglaise prévaudra en cas de divergence.',
      terms_footer: 'Des modifications peuvent s\'appliquer ; la poursuite de l\'utilisation du site vaut acceptation.'
  },
  ...
  'el': {
      ...
      heroSubtitle: 'Τεχνική Διαχείριση Περιουσίας για Διεθνείς Επενδυτές. Σας προστατεύουμε από "αγορές-εφιάλτες".', 
      heroCTA: 'Κλείστε Τεχνικό Έλεγχο',
      ...
      iconRigorText: 'Κατασκευαστικά πρότυπα στη διαχείριση.',
      iconGuardTitle: 'Φύλαξη Περιουσίας',
      iconGuardText: 'Προστασία της δομής όσο λείπετε.',
      ...
      serviceGateText: 'Πριν ταξιδέψετε στην Αθήνα, επιβεβαιώνουμε ότι η αγγελία ανταποκρίνεται στην πραγματικότητα. Σας γλιτώνουμε από άσκοπα έξοδα.',

      serviceAuthTitle: 'Η Αυθεντία (The Authority)',
      serviceAuthText: 'Πριν την υπογραφή, εκτελούμε πλήρη τεχνικό έλεγχο. Σας δίνουμε τα τεχνικά "όπλα" για τη διαπραγμάτευση της τιμής.',

      serviceGuardTitle: 'Ο Φύλακας (The Guardian)',
      serviceGuardText: 'Μετά την αγορά, αναλαμβάνουμε τη συντήρηση και την προστασία. Επαγγελματικές αναφορές για να έχετε το κεφάλι σας ήσυχο.',
      ...
      pkg_scan_title: 'Red Flag Scan<br><span class="text-3xl text-[--accent-color]">€97</span>',
      pkg_scan_desc: '<ul class="list-disc list-inside space-y-3 text-left"><li><b>Ο "Έλεγχος Λογικής"</b></li><li>45-λεπτη Οπτική Διάγνωση</li><li>Ετυμηγορία Go/No-Go</li></ul>',

      pkg_audit_title: 'Golden Ticket Audit<br><span class="text-3xl text-[--accent-color]">€490</span>',
      pkg_audit_desc: '<ul class="list-disc list-inside space-y-3 text-left"><li><b>Το "Όπλο Διαπραγμάτευσης"</b></li><li>Τεχνική Αναφορά 40 Σημείων</li><li>Έλεγχος Ηλεκτρολογικής Ασφάλειας</li><li>Έλεγχος Υγρασίας/Μούχλας</li><li>Προϋπολογισμός Επισκευών (CapEx)</li></ul>',

      pkg_guardian_title: 'Asset Guardian',
      pkg_guardian_desc: '<ul class="list-disc list-inside space-y-3 text-left"><li><b>Για Κενά Πολυτελή Ακίνητα</b></li><li>Μηνιαίος Τεχνικός Έλεγχος</li><li>Λειτουργία Υδραυλικών & A/C</li><li><b>Έλεγχος μετά από Σεισμό/Καταιγίδα</b></li><li>Έλεγχος Πρόσβασης Τεχνικών</li></ul>',
      ...
      rc_amcore_desc: 'Μηνιαία διαχείριση: διαλογή κινδύνων περιουσιακού στοιχείου, τεχνικός έλεγχος, οπτικός έλεγχος κάθε 6 μήνες/στην αλλαγή μισθωτή.',
      ...
      rc_guardpremium_desc: 'Φύλαξη Core, συν 2 επισκέψεις/μήνα, έκπλυση συστημάτων, αερισμός κατά της υγρασίας και συντονισμός πρόσβασης επισκεπτών.',
      ...
      faq_q1: "Τι είναι το Technical Asset Management;",
      faq_a1: "Το Technical Asset Management (TAM) αφορά τη διατήρηση της <b>δομικής και λειτουργικής αρτιότητας</b> του ακινήτου σας, προστατεύοντας την αξία του στον χρόνο.<br><br>Σε αντίθεση με την απλή διαχείριση ακινήτων, το TAM επικεντρώνεται στα <b>βασικά συστήματα και τη μακροπρόθεσμη υγεία</b> του κτιρίου.<br><br>Εντοπίζουμε κινδύνους και ανάγκες συντήρησης <b>πριν γίνουν δαπανηρά προβλήματα</b>, δίνοντάς σας σιγουριά για την επένδυσή σας.",
      
      faq_q2: "Πώς διαφέρει από την παραδοσιακή διαχείριση;",
      ...
      faq_a4: "Το Golden Ticket Audit είναι μια <b>πλήρης τεχνική αξιολόγηση</b>. Ελέγχουμε έξι σταθερές κατηγορίες:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Γενικό Περιβάλλον:</b> Συνολική υγεία και ασφάλεια του κτιρίου.</li><li><b>Ηλεκτρολογικά Συστήματα:</b> Ασφάλεια, λειτουργικότητα και αποδοτικότητα.</li><li><b>Υδραυλικά και Κλιματισμός:</b> Ροή, πίεση και συνολική ακεραιότητα.</li><li><b>Ξυλουργικά και Κουφώματα:</b> Πόρτες, παράθυρα και εξαρτήματα.</li><li><b>Φινιρίσματα και Επιφάνειες:</b> Ψηφία υγρασίας, φθορά και κρυφές ζημιές.</li><li><b>Εξοπλισμός και Λευκές Συσκευές:</b> Ψυγείο, φούρνος, πλυντήριο πιάτων και άλλες εντοιχισμένες συσκευές.</li></ul><br>Χρησιμοποιούμε προηγμένα εργαλεία όπως η <b>θερμογραφία</b> και <b>τεστ καταπόνησης</b> για να δημιουργήσουμε έναν <b>οδικό χάρτη επένδυσης</b>.<br><br><b>Πέρα από την Επιφάνεια:</b> Η θερμογραφία μας εντοπίζει κρυφή υγρασία, κενά μόνωσης και θερμογέφυρες που το γυμνό μάτι χάνει εντελώς.<br><br><a href='#packages' class='inline-block text-[--accent-color] font-bold hover:underline'>→ Αποκτήστε πλήρη εικόνα της υγείας του ακινήτου σας με ένα Golden Ticket Audit.</a>",
      faq_q5: "Πώς βοηθάει το πλάνο CapEx;",
      faq_a5: "Ο προγραμματισμός CapEx (Κεφαλαιουχικές Δαπάνες) σας βοηθά να <b>προβλέψετε μεγάλες επενδύσεις</b> σε ορίζοντα 5 ετών:<ul class='list-disc pl-5 mt-2 space-y-1'><li>Αποφεύγετε δαπανηρές επισκευές έκτακτης ανάγκης</li><li>Προστατεύετε την αξία και την απόδοση</li><li>Πραγματοποιείτε στρατηγικές αναβαθμίσεις</li></ul><br>Έτσι διαχειρίζεστε το χαρτοφυλάκιό σας <b>προληπτικά</b> και όχι κατασταλτικά.",
      
      faq_q6: "Χρειάζομαι ακόμα Μηχανικό ή Δικηγόρο;",
      faq_a6: "Ναι. Ο ρόλος μας είναι <b>αυστηρά τεχνικός και συμβουλευτικός</b>:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Πολιτικός Μηχανικός:</b> Απαραίτητος για πολεοδομικές εγκρίσεις</li><li><b>Δικηγόρος:</b> Απαραίτητος για τον έλεγχο τίτλων</li></ul><br>Η Klehomerie αναζητά την <b>«Παθολογία»</b>. Είμαστε τα τεχνικά σας μάτια στο πεδίο <b>πριν</b> εμπλέξετε τον νομικό μηχανισμό.<br>Εντοπίζουμε τα προβλήματα ώστε ο Μηχανικός να ξέρει πού να κοιτάξει.<br><br>Για το ακριβές όριο ανάμεσα στον τεχνικό μας ρόλο και τον νομικό τους ρόλο, δείτε το <a href='/scope/' class='text-[--accent-color] font-bold hover:underline'>πλήρες πεδίο των υπηρεσιών μας</a>.",
      
      faq_q7: "Για ποιους ΔΕΝ είναι η Klehomerie;",
      faq_a7: "Για να διατηρήσουμε τα υψηλά τεχνικά μας πρότυπα, δεν προσφέρουμε υπηρεσίες φιλοξενίας. Δεν είμαστε κατάλληλοι για:<ul class='list-disc pl-5 mt-2 space-y-1'><li><b>Διαχείριση Επισκεπτών:</b> Δεν αναλαμβάνουμε κρατήσεις Airbnb, check-in ή επικοινωνία με επισκέπτες.</li><li><b>Υπηρεσίες Concierge:</b> Δεν συντονίζουμε καθαρισμό, πλύσιμο ρούχων ή εσωτερική διακόσμηση.</li></ul><br><b>Η Klehomerie απευθύνεται σε Θεσμικούς & Έμπειρους Επενδυτές.</b><br>Είμαστε οι <b>Τεχνικοί Διευθυντές</b> του ακινήτου. Συνεργαζόμαστε άψογα <i>παράλληλα</i> με τον διαχειριστή σας. Εκείνοι κρατούν τους επισκέπτες χαρούμενους, εμείς κρατάμε το κτίριο όρθιο.",        
      faq_q8: "Γιατί όχι απλά ένας εργολάβος;",
      faq_a8: "Μπορείτε, αλλά ένας εργολάβος βγάζει χρήματα βρίσκοντας προβλήματα που <b>ο ίδιος</b> μπορεί να επιδιορθώσει.<br>Αυτό δημιουργεί μια <b>σύγκρουση συμφερόντων</b>. Η Klehomerie είναι <b>ανεξάρτητη</b>.<br>Δεν πουλάμε κατασκευαστικές εργασίες. Πουλάμε <b>αντικειμενικά δεδομένα</b>.<br>Όταν σας λέμε ότι ένας τοίχος χρειάζεται επισκευή, είναι επειδή είναι αλήθεια, όχι επειδή θέλουμε τη δουλειά του βαψίματος.<br>Η αμοιβή μας σας προστατεύει από περιττές προσφορές ανακαίνισης ύψους €5.000.<br><br><a href='https://calendar.app.google/pNE9HLdXuUtCwgEi7' target='_blank' class='inline-block text-[--accent-color] font-bold hover:underline'>→ Κλείστε μια 15λεπτη κλήση</a>",
      
      // Ευθυγράμμιση με Perplexity (Νέες ερωτήσεις ανεξαρτησίας)
      ...
      // --- CONTACT ---
      contactTitle: 'Ασφαλίστε την Περιουσία σας',
      contactName: 'Όνομα',
      contactEmail: 'Email',
      contactMessage: 'Τεχνικό Ζήτημα / Εκτίμηση Κινδύνου',
      ...
      methodologyEngine2Text: 'Ένας εις βάθος τεχνικός έλεγχος 40 σημείων σε έξι σταθερές κατηγορίες: γενικό περιβάλλον, ηλεκτρολογικά συστήματα, υδραυλικά και κλιματισμός, ξυλουργικά και κουφώματα, φινιρίσματα και επιφάνειες, εξοπλισμός και λευκές συσκευές. Το αποτέλεσμα είναι μια αναφορά βασικής κατάστασης και η 5ετής πρόβλεψη CapEx που αναφέρθηκε παραπάνω.',
      ...
      methodologyMandateText2: 'Το δηλώνουμε ξεκάθαρα, γιατί ένας διαχειριστής περιουσιακών στοιχείων που ισχυρίζεται ότι κάνει τα πάντα είναι συνήθως αυτός που δεν κάνει τίποτα σε επαληθεύσιμο επίπεδο. Η αξία μας είναι το εμπόδιο που βάζουμε ανάμεσα στο ακίνητό σας και το τοπικό επιχειρησιακό χάος, όχι μια αξίωση εξειδίκευσης που δεν διαθέτουμε. Η πλήρης λεπτομέρεια του πού ξεκινά και πού σταματά η εντολή μας, ανά κατηγορία, παρουσιάζεται στη <a href="/scope/" class="text-[--accent-color] font-bold hover:underline">σελίδα πεδίου των υπηρεσιών μας</a>.',
      ...
      privacy_s1_p: 'Ο υπεύθυνος για την επεξεργασία των προσωπικών σας δεδομένων είναι:',
      privacy_s1_ul: '<li><strong>Επωνυμία:</strong> Klehomerie (Arnaud Zerdab)</li><li><strong>ΑΦΜ:</strong> 174294556</li><li><strong>Έδρα:</strong> ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ</li><li><strong>E-mail επικοινωνίας:</strong> gdpr@klehomerie.com</li>',
      privacy_s2_h: '2. Τύποι Δεδομένων που Συλλέγουμε',
      privacy_s2_p: 'Συλλέγουμε και επεξεργαζόμαστε τις ακόλουθες κατηγορίες προσωπικών δεδομένων που είναι απαραίτητες για τις υπηρεσίες μας:',
      privacy_s2_ul: '<li><strong>Δεδομένα Ταυτότητας:</strong> Ονοματεπώνυμο, πατρώνυμο, αριθμός ταυτότητας/διαβατηρίου, ΑΦΜ.</li><li><strong>Δεδομένα Επικοινωνίας:</strong> Διεύθυνση e-mail, τηλέφωνο, διεύθυνση κατοικίας.</li><li><strong>Δεδομένα Περιουσιακού Στοιχείου:</strong> Στοιχεία ιδιοκτησίας, τοποθεσία του ακινήτου, τεχνικά χαρακτηριστικά, αρχεία κατάστασης, κλειδιά και κωδικούς πρόσβασης.</li><li><strong>Οικονομικά Δεδομένα:</strong> Στοιχεία τραπεζικού λογαριασμού (IBAN) για την επιστροφή εξόδων και την πληρωμή αμοιβών (δεν αποθηκεύουμε αριθμούς πιστωτικών καρτών).</li>',
      privacy_s2_p2: 'Δεν συλλέγουμε ούτε επεξεργαζόμαστε ειδικές κατηγορίες δεδομένων προσωπικού χαρακτήρα, όπως ορίζονται στο Άρθρο 9 του ΓΚΠΔ.',
      privacy_s3_h: '3. Σκοπός Επεξεργασίας',
      privacy_s3_p: 'Τα δεδομένα σας υφίστανται επεξεργασία για τους ακόλουθους συγκεκριμένους σκοπούς:',
      privacy_s3_ul: '<li><strong>Σκοποί μάρκετινγκ:</strong> Για την αποστολή ενημερωτικών δελτίων, τεχνικών αναλύσεων και προωθητικών ενημερώσεων σχετικά με τις υπηρεσίες διαχείρισης περιουσιακών στοιχείων της Klehomerie, με την ρητή συγκατάθεσή σας.</li><li><strong>Εκτέλεση Σύμβασης:</strong> Για την εκτέλεση της Σύμβασης Τεχνικής Διαχείρισης Περιουσιακών Στοιχείων, τον συντονισμό επισκευών και έργων CapEx, και την εκπροσώπησή σας ενώπιον εταιρειών κοινής ωφέλειας (ΔΕΔΔΗΕ, ΕΥΔΑΠ) στο πλαίσιο της εντολής σας.</li><li><strong>Νομική Συμμόρφωση:</strong> Για τη συμμόρφωση με φορολογικές υποχρεώσεις (δηλώσεις ΑΑΔΕ) και άλλες κανονιστικές απαιτήσεις.</li><li><strong>Επικοινωνία:</strong> Για την ενημέρωσή σας σχετικά με την κατάσταση του ακινήτου σας, την αποστολή αναφορών Τεχνικού Ελέγχου, και την απάντηση στα ερωτήματά σας.</li><li><strong>Εκπαιδευτικό Περιεχόμενο &amp; Μελέτες Περίπτωσης:</strong> Για την ανάλυση τεχνικών δεδομένων περιουσιακών στοιχείων με σκοπό τη δημιουργία αναλύσεων κλάδου και μελετών περίπτωσης, με πλήρη ανωνυμοποίηση όλων των προσωπικών στοιχείων και των συγκεκριμένων τοποθεσιών πριν από οποιαδήποτε δημοσίευση.</li><li><strong>Ακεραιότητα Αρχείων και Νομική Υπεράσπιση:</strong> Για την τήρηση αρχείων εντολών, εργασιών και τεχνικών ευρημάτων, την ασφάλεια των συστημάτων μας, και τη θεμελίωση, άσκηση ή υπεράσπιση νομικών αξιώσεων.</li>',
      privacy_s4_h: '4. Νομική Βάση',
      privacy_s4_p: 'Βάσει του Άρθρου 6 του ΓΚΠΔ, κάθε σκοπός ανωτέρω στηρίζεται σε συγκεκριμένη νόμιμη βάση:',
      privacy_s4_ul: '<li><strong>Συμβατική αναγκαιότητα (Άρθρο 6(1)(β)):</strong> Εκτέλεση Σύμβασης και Επικοινωνία.</li><li><strong>Νομική υποχρέωση (Άρθρο 6(1)(γ)):</strong> Νομική Συμμόρφωση, συμπεριλαμβανομένης της ελληνικής φορολογικής και λογιστικής νομοθεσίας.</li><li><strong>Έννομο συμφέρον (Άρθρο 6(1)(στ)):</strong> Ακεραιότητα Αρχείων και Νομική Υπεράσπιση. Έχουμε εκτιμήσει ότι τα συμφέροντα αυτά δεν υπερισχύουν των δικαιωμάτων και ελευθεριών σας. Μπορείτε να αντιταχθείτε ανά πάσα στιγμή (βλ. Ενότητα 8).</li><li><strong>Συγκατάθεση (Άρθρο 6(1)(α)):</strong> Σκοποί μάρκετινγκ και Εκπαιδευτικό Περιεχόμενο &amp; Μελέτες Περίπτωσης.</li>',
      privacy_s4_p2: 'Η συγκατάθεση είναι προαιρετική και ανεξάρτητη από τη Σύμβαση Παροχής Υπηρεσιών σας. Η παροχή ή η άρνησή της δεν επηρεάζει τις υπηρεσίες που λαμβάνετε και μπορεί να ανακληθεί ανά πάσα στιγμή, χωρίς χρέωση.',
      privacy_s5_h: '5. Αποδέκτες Δεδομένων',
      privacy_s5_p: 'Δεν πωλούμε τα δεδομένα σας. Ενδέχεται να μοιραστούμε τα απαραίτητα δεδομένα με:',
      privacy_s5_ul: '<li><strong>Δημόσιες Αρχές:</strong> Φορολογικές αρχές (ΑΑΔΕ) και παρόχους κοινής ωφέλειας (ΔΕΔΔΗΕ, ΕΥΔΑΠ) όταν απαιτείται από τον νόμο ή για την εκτέλεση της σύμβασης.</li><li><strong>Τρίτους Παρόχους:</strong> Έμπιστους συνεργάτες (υδραυλικούς, ηλεκτρολόγους, μηχανικούς) αποκλειστικά για εργασίες συντήρησης και επισκευής στο ακίνητό σας.</li><li><strong>Επαγγελματίες Συμβούλους:</strong> Λογιστές και νομικούς συμβούλους που δεσμεύονται από εχεμύθεια.</li>',
      privacy_s6_h: '6. Διεθνείς Διαβιβάσεις Δεδομένων',
      privacy_s6_p: 'Όπου η Klehomerie χρησιμοποιεί εργαλεία βασισμένα σε cloud (όπως το Google Workspace) για την αποθήκευση ή επεξεργασία των δεδομένων σας, οποιαδήποτε διαβίβαση προσωπικών δεδομένων εκτός του Ευρωπαϊκού Οικονομικού Χώρου πραγματοποιείται με τις κατάλληλες εγγυήσεις, συμπεριλαμβανομένων των Τυποποιημένων Συμβατικών Ρητρών (SCCs) της Ευρωπαϊκής Επιτροπής, σύμφωνα με το Κεφάλαιο V του ΓΚΠΔ.',
      privacy_s7_h: '7. Διατήρηση Δεδομένων',
      privacy_s7_p1: 'Διατηρούμε τα προσωπικά σας δεδομένα για όσο διαρκεί η συμβατική μας σχέση. Μετά τη λήξη της, τα δεδομένα διατηρούνται μόνο για το χρονικό διάστημα που απαιτείται από την ελληνική φορολογική και λογιστική νομοθεσία (συνήθως πέντε έως δέκα έτη) ή για την επίλυση νομικών διαφορών, μετά το οποίο διαγράφονται με ασφάλεια.',
      privacy_s7_p2: 'Κλειδιά, κωδικοί συναγερμού και διαπιστευτήρια πρόσβασης επιστρέφονται ή καταστρέφονται εντός 30 ημερών από τη λήξη της σύμβασης, ανεξαρτήτως της περιόδου διατήρησης που ισχύει για τα λοιπά αρχεία.',
      privacy_s8_h: '8. Τα Δικαιώματά σας',
      privacy_s8_p: 'Βάσει του ΓΚΠΔ, έχετε το δικαίωμα:',
      privacy_s8_ul: '<li><strong>Πρόσβασης:</strong> Να ζητήσετε αντίγραφο των προσωπικών δεδομένων που τηρούμε για εσάς.</li><li><strong>Διόρθωσης:</strong> Να διορθώσετε ανακριβή ή ελλιπή δεδομένα.</li><li><strong>Διαγραφής (« δικαίωμα στη λήθη »):</strong> Να ζητήσετε τη διαγραφή των δεδομένων σας, με την επιφύλαξη των νόμιμων υποχρεώσεων διατήρησης.</li><li><strong>Περιορισμού:</strong> Να ζητήσετε τον περιορισμό της επεξεργασίας των δεδομένων σας.</li><li><strong>Εναντίωσης:</strong> Να αντιταχθείτε σε επεξεργασία που βασίζεται στα έννομα συμφέροντά μας ή που διενεργείται για σκοπούς άμεσου μάρκετινγκ.</li><li><strong>Ανάκλησης Συγκατάθεσης:</strong> Να ανακαλέσετε οποιαδήποτε συγκατάθεση έχετε δώσει, ανά πάσα στιγμή και χωρίς χρέωση. Η ανάκληση δεν θίγει τη νομιμότητα της επεξεργασίας που πραγματοποιήθηκε πριν από αυτήν και δεν έχει καμία επίπτωση στη Σύμβαση Παροχής Υπηρεσιών σας.</li><li><strong>Φορητότητας:</strong> Να λάβετε τα δεδομένα σας σε δομημένη, κοινώς χρησιμοποιούμενη μορφή.</li>',
      privacy_s8_p2: 'Για να ασκήσετε αυτά τα δικαιώματα, επικοινωνήστε μαζί μας στο <a href="mailto:gdpr@klehomerie.com" class="text-[--accent-color] font-bold">gdpr@klehomerie.com</a>. Θα απαντήσουμε εντός ενός μηνός από την παραλαβή του αιτήματός σας.',
      privacy_s8_p3: 'Έχετε επίσης το δικαίωμα υποβολής καταγγελίας στην Αρχή Προστασίας Δεδομένων Προσωπικού Χαρακτήρα, εάν πιστεύετε ότι έχουν παραβιαστεί τα δικαιώματά σας για την προστασία δεδομένων:',
      privacy_s8_p4: 'Κηφισίας 1-3, 115 23 Αθήνα | Τηλ. +30 210 6475600 | <a href="mailto:contact@dpa.gr" class="text-[--accent-color] font-bold">contact@dpa.gr</a> | <a href="https://www.dpa.gr" class="text-[--accent-color] font-bold" target="_blank" rel="noopener">www.dpa.gr</a>',
      privacy_s9_h: '9. Ασφάλεια',
      privacy_s9_p: 'Εφαρμόζουμε κατάλληλα τεχνικά και οργανωτικά μέτρα για την προστασία των δεδομένων σας από μη εξουσιοδοτημένη πρόσβαση, απώλεια ή κακή χρήση. Αυτό περιλαμβάνει ασφαλή ψηφιακή αποθήκευση και περιορισμένη πρόσβαση σε φυσικά αρχεία.',
      privacy_s10_h: '10. Ενημερώσεις',
      privacy_s10_p: 'Ενδέχεται να ενημερώνουμε την παρούσα ειδοποίηση ώστε να αντικατοπτρίζει νομικές ή λειτουργικές αλλαγές. Κάθε έκδοση φέρει αριθμό έκδοσης και ημερομηνία έναρξης ισχύος. Η τελευταία έκδοση είναι πάντα διαθέσιμη στον ιστότοπό μας.',

      // --- TERMS OF SERVICE ---
      terms_title: 'ΝΟΜΙΚΗ ΕΙΔΟΠΟΙΗΣΗ ΚΑΙ ΟΡΟΙ ΠΑΡΟΧΗΣ ΥΠΗΡΕΣΙΩΝ',
      terms_updated: 'Τελευταία Ενημέρωση: Ιούλιος 2026',
      terms_s1_h: '1. Νομική Ταυτότητα',
      terms_s1_p1: 'Οι υπηρεσίες παρέχονται από την <strong>Klehomerie</strong> (ΑΦΜ: 174294556), με έδρα ΕΡΥΘΡΟΥ ΣΤΑΥΡΟΥ 20, 17778 ΤΑΥΡΟΣ, Ελλάδα.',
      terms_s1_contact: '<strong>Επικοινωνία:</strong> <a href="mailto:info@klehomerie.com" class="hover:text-[--accent-color]">info@klehomerie.com</a><br><strong>Τηλέφωνο:</strong> +30 694 020 6368<br><strong>Ιστότοπος:</strong> <a href="https://www.klehomerie.com" target="_blank">www.klehomerie.com</a>',
      terms_s2_h: '2. Φύση των Υπηρεσιών &amp; Ευθύνη',
      ...
      terms_s4_p: 'Τα τιμολόγια είναι πληρωτέα εντός <strong>7 εργάσιμων ημερών</strong> από την έκδοσή τους, εκτός αν ορίζεται διαφορετικά με ιδιωτική συμφωνία. Οι καθυστερημένες πληρωμές επιβαρύνονται με τόκο ίσο με το βασικό επιτόκιο της ΕΚΤ πλέον 8%.',
      terms_s5_h: '5. Δικαιώματα Πελάτη &amp; Καταγγελία',
      terms_s5_ul: '<li><strong>Μηνιαία Πακέτα Υπηρεσιών:</strong> Ο πελάτης μπορεί να καταγγείλει με <strong>έγγραφη προειδοποίηση 14 ημερών, μετά από αρχική περίοδο 3 μηνών</strong>. Οι <strong>αναθέσεις βάσει έργου</strong> μπορούν να καταγγελθούν από οποιοδήποτε μέρος πριν από την ολοκλήρωσή τους με <strong>έγγραφη προειδοποίηση 7 ημερών</strong>, σύμφωνα με την εφαρμοστέα Σύμβαση Παροχής Υπηρεσιών.</li><li><strong>Δικαίωμα υπαναχώρησης:</strong> Οι καταναλωτές έχουν δικαίωμα υπαναχώρησης εντός 14 ημερών από συμβάσεις εξ αποστάσεως, σύμφωνα με τον Νόμο 2251/1994.</li><li>Μπορούμε να καταγγείλουμε άμεσα σε περίπτωση ουσιώδους παράβασης (π.χ. μη εγκεκριμένη παρέμβαση εργολάβου, καταχρηστική συμπεριφορά ή μη πληρωμή).</li>',
      terms_s6_h: '6. Προστασία Δεδομένων (ΓΚΠΔ)',
      terms_s6_p1: 'Επεξεργαζόμαστε προσωπικά δεδομένα σύμφωνα με τον ΓΚΠΔ της ΕΕ και τον Ελληνικό Νόμο 4624/2019. Οι πελάτες μπορούν να αποκτήσουν πρόσβαση, να διορθώσουν, να διαγράψουν, να περιορίσουν ή να αντιταχθούν στην επεξεργασία μέσω <a href="mailto:gdpr@klehomerie.com">gdpr@klehomerie.com</a>.',
      terms_s6_p2: 'Η πλήρης πολιτική είναι διαθέσιμη εδώ: <a href="/legal/privacy/" class="text-[--accent-color] font-bold hover:underline">Πολιτική Απορρήτου</a>.',
      terms_s7_h: '7. Πνευματική Ιδιοκτησία &amp; Χρήση Ιστότοπου',
      terms_s7_p: 'Το περιεχόμενο του ιστότοπου ανήκει στην Klehomerie. Οι χρήστες δεν επιτρέπεται να το αναπαράγουν χωρίς άδεια. Αποποιούμαστε κάθε ευθύνη για περιεχόμενο που υποβάλλεται από χρήστες.',
      terms_s8_h: '8. Εφαρμοστέο Δίκαιο &amp; Διαφορές',
      terms_s8_p1: 'Οι παρόντες Όροι διέπονται από το ελληνικό δίκαιο. Οι διαφορές υπάγονται στην αποκλειστική δικαιοδοσία των Δικαστηρίων Αθηνών. Για καταναλωτές της ΕΕ, εναλλακτική επίλυση διαφορών είναι διαθέσιμη μέσω <a href="https://www.eccnet.eu" target="_blank" rel="nofollow" class="underline">www.eccnet.eu</a>.',
      terms_s8_p2: 'Οι παρόντες Όροι δημοσιεύονται στα αγγλικά· όπου υπάρχουν μεταφρασμένες εκδόσεις, η αγγλική έκδοση υπερισχύει σε περίπτωση απόκλισης.',
      terms_footer: 'Ενδέχεται να ισχύουν αλλαγές. Η συνέχιση της χρήσης συνεπάγεται αποδοχή.'
  }
};